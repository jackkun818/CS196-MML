...
namespace crs.dialog.Views
{
    ...
    public partial class TrainReport : UserControl
    {
        ...
        async void ExportPDFButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            string xpsFilePath = filePath_XPS + $"\\{(DataContext as TrainReportViewModel).DateTime.Substring(0, 10)}_{(DataContext as TrainReportViewModel).ModuleItem.Name}.xps";
            string pdfFilePath = filePath_PDF + $"\\{(DataContext as TrainReportViewModel).DateTime.Substring(0, 10)}_{(DataContext as TrainReportViewModel).ModuleItem.Name}.pdf";
