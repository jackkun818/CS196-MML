...
{
    /// <summary>
    /// Interaction logic for MocaReport
    /// </summary>
    public partial class MocaReport : UserControl
    {
        public MocaReport()
        {
            InitializeComponent();
        ...
        async void ExportPDFButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            string xpsFilePath = filePath_XPS + $"\\{(DataContext as MocaReportViewModel).DateTime.Substring(0, 10)}_{(DataContext as MocaReportViewModel).ModuleItem.Name}.xps";
            string pdfFilePath = filePath_PDF + $"\\{(DataContext as MocaReportViewModel).DateTime.Substring(0, 10)}_{(DataContext as MocaReportViewModel).ModuleItem.Name}.pdf";
